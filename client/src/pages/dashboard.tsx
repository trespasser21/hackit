      ...
      case 'sellers':
        return (
          <div className="lg:col-span-3">
            <CustomerInterface isSellerView={true} />
          </div>
        );
      case 'moderation':
        return (
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Hero Section with Live Stats - Only show on analytics and moderation tabs */}
        ...
        {activeTab !== 'sellers' && activeTab !== 'analytics' && activeTab !== 'moderation' && (
          <div className="mt-8">
            <CustomerInterface isSellerView={false} />
          </div>
        )}
